...
import { FaCheckCircle, FaCloudUploadAlt, FaTrashAlt } from 'react-icons/fa';
    ...
    <main className="page-shell py-8">
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="glass-panel rounded-[36px] p-6 md:p-8">
          ...
          <h1 className="mt-3 text-4xl font-bold text-slate-900">Presenta una propiedad con nivel profesional</h1>
          <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600">
            Describe bien el inmueble, carga imagenes limpias y destaca lo que hace que valga la
            pena una visita.
          </p>
          ...
          <div className="glass-panel rounded-[36px] p-6 md:p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-bold text-slate-900">La primera imagen vende el anuncio</h2>
              </div>
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">
              Usa hasta 6 imagenes. Prioriza portada limpia, buena luz y encuadres que expliquen el
              espacio.
            </p>
